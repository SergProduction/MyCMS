...
mysql_query ("INSERT INTO product (parent_category, name, text, image, title, keywords, description) VALUES('$parent_category', '$name', '$text', '$src_file', '$title', '$keywords', '$descrition')");
