...
mysql_query ("INSERT INTO share (parent_category, name, text, text_detail, image, title, keywords, description) VALUES('$parent_category', '$name', '$text', '$detail_text', '$src_file', '$title', '$keywords', '$descrition')");
